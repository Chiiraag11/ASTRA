...
import type { APKMetadata, RiskResult } from '../services/api';
...
type ScanAction =
  ...
  | { type: 'SET_VERDICT'; payload: { verdict: 'safe' | 'suspicious' | 'unsafe'; officialUrl?: string } }
  | { type: 'SET_BACKEND_RESULT'; payload: { metadata: APKMetadata; risk: RiskResult } }
  | { type: 'SET_URL_RESULT'; payload: ScanData['urlScanResult'] }
...
function scanReducer(state: ScanState, action: ScanAction): ScanState {
  switch (action.type) {
    ...
    case 'SET_URL_RESULT':
      return { ...state, data: { ...state.data, urlScanResult: action.payload } };
    case 'SET_BACKEND_ERROR':
      return { ...state, data: { ...state.data, backendError: action.payload } };
    case 'COMPLETE_SCAN':
